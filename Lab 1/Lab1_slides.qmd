...
- How to install `R` from [CRAN (The Comprehensive R Archive Network)](https://cloud.r-project.org/).
  - Mac: choose "R-4.2.3-arm64.pkg" for Apple silicon Macs (M1 or higher); otherwise choose "R-4.2.3.pkg".
  - Windows: quite straightforward ...
- Two components:
  - `R` console
...
## If you have problems generating PDF from Rmarkdown
