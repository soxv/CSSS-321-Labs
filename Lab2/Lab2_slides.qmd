...
- Let's take 5 minutes to open the `.Rmd` file from Canvas!
- Review how to set working directory or open `R` project to find the target folder.
- Try to load the dataset `transphobia.csv` in the `.Rmd` file.
- Try to generate a PDF from the `.Rmd` file.
